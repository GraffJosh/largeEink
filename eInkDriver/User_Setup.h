...
// #define TFT_MOSI  PIN_D10  // Automatically assigned with ESP8266 if not defined
// #define TFT_SCLK  PIN_D8  // Automatically assigned with ESP8266 if not defined

// #define TFT_CS    PIN_D7  // Chip select control pin D8
